/*
* Adapted from the below Intel Sample:
* 
...
function onOK_GetFile(fileEntry) {
    ...
    var msg = "audioJs: onOK_GetFile(): start";
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

    msg = "audioJs: onOK_GetFile(): File Name: " + mediaRecFile + " at " + fileEntry.fullPath;
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
...
function onFail_GetFile(evt) {
    ...
    var msg = "audioJs: onFail_GetFile(): ";
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

    msg = "audioJs: onFail_GetFile(): error code: " + evt.target.error.code;
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

}

function onSuccessFileSystemAudioLoad(fileSystem) {
    console.log("***test: fileSystem.root.name: " + fileSystem.root.name);

    var msg = "audioJs: onSuccessFileSystemAudioLoad(): start";
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

    msg = "audioJs: onSuccessFileSystemAudioLoad(): Root File System Name: " + fileSystem.root.name;
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
    ...
    msg = "audioJs: onSuccessFileSystemAudioLoad(): end";
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

}

function onFailFileSystemAudioLoad (evt){

    var msg = "audioJs: onFailFileSystemAudioLoad(): start";
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

    console.log(evt.target.error.code);

    msg = "audioJs: onFailFileSystemAudioLoad(): error code: " + evt.target.error.code;
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

    var msg = "audioJs: onFailFileSystemAudioLoad(): end";
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

}
function audioCheckMediaRecFileExist() {

    var msg = "audioJs: audioCheckMediaRecFileExist(): start";
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

    checkFileOnly = true;
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, onSuccessFileSystemAudioLoad, onFailFileSystemAudioLoad);

    msg = "audioJs: audioCheckMediaRecFileExist(): end";
    console.log(msg);
...
function startRecording() {
    ...
    var msg = "audioJs: startRecording(): start";
    console.log(msg);
    $('#pocCleanPageDebugArea').val( $('#pocCleanPageDebugArea').val() + msg + '\n');
...
//    else if (phoneCheck.ios) {
    ...
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, onSuccessFileSystem, function() {
        ...
        msg = "audioJs: startRecording(): failed in requestFileSystem call";
        console.log(msg);
        $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
    });
...
//    }
    ...
    msg = "audioJs: startRecording(): end";
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
...
function stopRecording() {
    ...
    var msg = "audioJs: stopRecording(): start. ";
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

    msg = "audioJs: stopRecording(): Src attribute before dynamic set: ";
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
    ...
    msg = "audioJs: stopRecording(): Src attribute after dynamic set: ";
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
    msg =  $("#pocMediaAudioPlayCtl").attr("src")   ;
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
    setButtonState(myMediaState.finishRec);
    ...
    var msg = "audioJs: stopRecording(): end. ";
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
}
...
function audioSetButtonState(curState)
{
    var msg = "audioJs: mediaHandlers: audioSetButtonState: start.  called with: " + curState;
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');

    var id_disabled_map = {"audioStartRecID":false,
        "audioStopRecID":true};
//        "startPlayID":true,
//        "pausePlayID":true,
//        "stopPlayID":true};
...
//    }
    ...
    var msg = "audioJs: mediaHandlers: setButtonState: end.  called with: " + curState;
    console.log(msg);
    $('#pocCleanPageDebugArea').val($('#pocCleanPageDebugArea').val() + msg + '\n');
